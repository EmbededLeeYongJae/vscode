...
// 메소드 내에 있는 일반함수의 this를 메소드를 호출한 객체로 바인딩 하려면..
// 1) 일반함수 바깥에서 다른 변수에 this를 담아서 다른 변수를 일반함수 안에서 사용
// 2) call, apply, bind 메소드로 일반함수내의 this를 메소드 호출 객체로 바인딩해준다.
...
/*
    ...
    // btn 이벤트 타겟객체, onclick:이벤트속성, 이벤트명: click
